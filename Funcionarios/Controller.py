from Funcionarios.DAO import PessoaDAO
from Funcionarios.Models import Pessoa
import re
...
class FuncionariosController:
    ...
    @classmethod
    def salvar_funcionario(cls, nome: str, cpf:str, email:str):
        id_pessoa = PessoaDAO.ler_todas_as_pessoas()
        id_pessoa = id_pessoa[1] + 1
        tipo_pessoa = {"id": "2","tipo":"Funcionario"}
